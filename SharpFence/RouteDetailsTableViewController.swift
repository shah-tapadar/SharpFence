...
class RouteDetailsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
       ...
       self.gfID.text = data?.gfID
       self.time.text = data?.time
        self.latitude.text = data?.latitude
        self.longitude.text = data?.longitude
        self.distanceFromCenter.text = data?.distanceFromCenter
    }
    
    @IBOutlet weak var gfID: UILabel!
    ...
    @IBOutlet weak var distanceFromCenter: UILabel!
